		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Scandialog POC",
									"targetURL": "#arvatocxscandialog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arvatocxscandialog-display": {
								"semanticObject": "arvatocxscandialog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=arvato.cx.scandialog",
									"url": sap.ui.require.toUrl("arvato/cx/scandialog")
								}
							}
						}
					}
